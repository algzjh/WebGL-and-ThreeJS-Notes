(function () {
    ...
    var theMilkyWay, theSun, mercury, venus, earth, moon, mars, asteroidBelt, jupiter, saturn, saturnRing, uranus, neptune;
    /*
    theMilkyWay: 银河系
    theSun: 太阳
    mercury: 水星
    ...
    */
    ...
    var moonSize = 0.75,
        moonOrbitRadius = (AU * 0.1257),
        moonOrbitAngle = getRandomArbitrary(0, 360),
        moonOrbitSpeed = 1.5,
        moonRotateSpeed = 0.0019;
    ...
    var moonSize = 0.75,
        moonOrbitRadius = (AU * 0.00257),
        moonOrbitAngle = getRandomArbitrary(0, 360),
        moonOrbitSpeed = 0.033,
        moonRotateSpeed = 0.0019;
    */
